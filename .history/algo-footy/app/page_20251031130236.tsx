  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
        ...
        <main className="grid grid-cols-3 gap-10 px-20">
            <div className="content-center pb-20 flex flex-col gap-4">
                <TfiStatsUp className="text-8xl"/>
                <h1 className="text-6xl font-bold">STATISTICAL INSIGHTS</h1>
                <p className="text-xl">Use our diverse and extensive match stats to make correct 
