  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
        <main className="grid grid-cols-3">
            <div className="col-span-2 flex flex-col py-34 px-20">
                <GiAzulFlake className="text-9xl"/>
                <h1 className="text-9xl font-bold">SURE MATCH PREDICTIONS</h1>
                <p>Maximize your wins with our 100% AI predictions. Our hybrid model ensures top most accuracy while analysing upcoming matches
