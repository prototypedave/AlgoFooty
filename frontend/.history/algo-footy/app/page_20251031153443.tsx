...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
        <main className="flex flex-col w-full items-center justify-items-center bg-orange-red min-h-96 px-20 gap-4">
          <h1 className="text-9xl font-bold">POPUP SURE PREDICTIONS</h1>
          <p>Join us for accurate predictions, insights, and analysis to enhance your betting experience</p>
        </main>
