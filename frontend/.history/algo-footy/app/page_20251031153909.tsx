...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
        <main className="flex flex-col w-full justify-center bg-orange-red min-h-96 px-20 gap-4">
          <h1 className="text-9xl font-bold">POPUP SURE PREDICTIONS</h1>
          <p className="text-2xl font-bold text-left">Join us for accurate predictions, insights, and analysis to enhance your betting experience</p>
          <button className="font-bold text-left text-2xl underline py-20">ALGO-FOOTY APP</button>
        </main>
