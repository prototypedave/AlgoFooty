...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
        ...
        <main className="grid grid-cols-3 px-20 mt-40 gap-10">
            ...
            <div className="span-col-2 content-end flex flex-col w-full">
                <FaRankingStar className="text-8xl"/>
                <h1 className="text-8xl font-bold">PROBALISTIC PREDICTIONS</h1>
                <p className="text-xl w-full">Get predictions with probability ratings to act as a guide on 
