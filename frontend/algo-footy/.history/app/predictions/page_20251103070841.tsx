...
export default function Predictions() {
    ...
    return (
        <div className="relative flex flex-col min-h-screen items-center justify-center bg-[#001730] font-sans">
            <nav className="absolute inset-x-0 top-0 bottom-0 bg-oxford-blue text-white max-h-full rounded-md mx-8 my-14 shadow-lg flex gap-10 p-4">
