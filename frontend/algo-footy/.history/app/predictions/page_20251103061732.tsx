...
export default function Predictions() {
    ...
    return (
        <div className="relative flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
            <nav className="absolute inset-x-0 top-0 bottom-0 bg-gradient-to-r from-[#001730] to-[#004080] text-white min-h-screen rounded-md mx-4 my-18 shadow-lg flex flex-col p-4">
