...
export default function Predictions() {
    ...
    return (
        <div className="relative flex flex-col min-h-screen items-center justify-center bg-oxford-blue font-sans">
            <nav className="absolute inset-x-0 top-0 bg-gradient-to-r from-[#001730] to-[#004080] text-white h-28 rounded-md mx-4 mt-18 shadow-lg flex flex-col p-4">
                ...
                <div className="flex items-center gap-20 pt-4 pl-6 font-bold text-lg text-gray-950">
                    <Link
                        href="/home"
                        className={`pb-1 ${
                        pathname === "/home"
