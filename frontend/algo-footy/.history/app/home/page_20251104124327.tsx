...
export default function Home() {
  return (
    <div className="flex flex-col p-4 gap-4 w-full items-center justify-center bg-oxford-blue font-sans">
        <main className="flex justify-center items-center h-48">
          <button className="rounded-full bg-white h-20 text-orange-red text-4xl font-bold p-6">
            TODAYS PREDICTIONS
          </button>

        </main>
        <main className="flex flex-col w-full justify-center bg-orange-red min-h-[500px] px-20 gap-4">
            <motion.h1
