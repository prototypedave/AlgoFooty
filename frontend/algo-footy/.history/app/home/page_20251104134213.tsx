...
export default function Home() {
  return (
    <div className="flex flex-col p-4 w-full font-sans overflow-y-auto">
      <main className="flex justify-center items-center h-64 w-full p-6">
        <Link href="/predictions" className="rounded-full bg-white h-16 text-orange-red text-2xl font-bold p-6">
      ...
      <main className="grid grid-cols-3 px-20 mt-40 gap-10 mb-40">
        ...
        <div className="col-span-2 content-center">
          ...
          <p className="text-md">Get predictions with probability ratings to act as a guide on 
